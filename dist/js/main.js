...
var MiniSlider = /*#__PURE__*/function (_Slider) {
  ...
  function MiniSlider(contentClass, next, prev, sliderWrapper, sliderInner) {
    ...
    _this.offset = 0;
    _this.screen = window.screen.availWidth;
    return _this;
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function show() {
      ...
      this.contentClass.forEach(function (slide) {
        ...
        if (_this2.screen < 1060) {
          slide.style.width = parseInt(_this2.width) / 2 + 'px';
        }

        if (_this2.screen < 760) {
          slide.style.width = parseInt(_this2.width) + 'px';
        }
      });
    }
  }, {
...
var Burger = /*#__PURE__*/function () {
  ...
  _createClass(Burger, [{
    key: "burgerActiveClass",
    value: function burgerActiveClass(burger) {
...
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/burger */ "./js/modules/burger.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  DropDown.init();
  var burger = new _modules_burger__WEBPACK_IMPORTED_MODULE_7__["default"]({
